...
## Key Charts Produced by the Study

- DVAR Out of Sample Forecast for Δp1
  ![DVAR Forecast](dvar_forecasts/dvar_dp1.png)

- ARIMA Out of Sample Forecast for Δp1
  ![ARIMA Forecast](arima_forecasts/arima_dp1.png)

- Stationarity of Interest Rates
  ![Interest Rate Stationarity](individual_rates_stationarity.png)

- Stationarity of Interet Rate Spreads
  ![Interest Rate Spread Stationarity](spread_stationarity.png)
